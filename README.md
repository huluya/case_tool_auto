...
![项目与版本列表](docs/images/project-version-list.png)

*项目列表展开后显示版本；单击版本即可切换到该版本。*
...
![编辑模式下显示的编辑和删除按钮](docs/images/edit-mode-actions.png)

*管理按钮只在编辑模式且具备管理权限时显示；版本名称过长时可停留鼠标查看完整名称。*
...
![文字与图片混排示例](docs/images/rich-text-image.png)

*备注中可以同时保存文字和图片；列表单元格按缩略图方式显示图片内容。*
...
![Excel 删除线示例](docs/images/excel-strikethrough.png)

*Excel 中原本带删除线的文字，导入后仍保留删除线效果。*
